...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.labelColor = [UIColor colorWithRed:103/255.0 green:103/255.0 blue:103/255.0 alpha:1.0];
        self.detailsLabelFont = [UIFont boldSystemFontOfSize:kDetailsLabelFontSize];
        self.detailsLabelColor = [UIColor whiteColor];
        self.activityIndicatorColor = [UIColor colorWithRed:255/255.0 green:68/255.0 blue:102/255.0 alpha:1.0];
        self.xOffset = 0.0f;
        self.yOffset = 0.0f;
